...
from bible_way.models import Wallpaper
from bible_way.storage.s3_utils import s3_client, BUCKET_NAME, REGION


class Command(BaseCommand):
    help = 'Extract images from themes Jpeg.zip and upload them to S3'

    def add_arguments(self, parser):
        parser.add_argument(
            '--zip-path',
            type=str,
            default='themes Jpeg.zip',
            help='Path to the zip file (default: themes Jpeg.zip in project root)'
        )
            ...
            with zipfile.ZipFile(zip_path, 'r') as zip_ref:
                ...
                for idx, filename in enumerate(file_list, 1):
                    ...
                    try:
                        ...
                        s3_key = f"wallpapers/{file_uuid}/{safe_filename}"
