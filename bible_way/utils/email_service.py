...
class ZeptoMailService:
    ...
    def send_password_reset_email(self, user_email: str, user_name: str, otp: str) -> tuple[bool, str]:
        """
        ...
        try:
            payload = {
                ...
                "subject": "Reset Your Password - Bible Way",
                "htmlbody": f"""
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    <h2 style="color: #333;">Password Reset Request</h2>
                    <p>Hello {user_name},</p>
                    <p>We received a request to reset your password for your Bible Way account. Please use the following OTP code to reset your password:</p>
                    <div style="background-color: #f4f4f4; padding: 20px; text-align: center; margin: 20px 0;">
                        <h1 style="color: #007bff; font-size: 32px; margin: 0; letter-spacing: 5px;">{otp}</h1>
                    </div>
                    <p>This code will expire in 15 minutes.</p>
                    <p>If you didn't request a password reset, please ignore this email. Your password will remain unchanged.</p>
                    <p>For security reasons, never share this OTP code with anyone.</p>
                    <p>Best regards,<br>The Bible Way Team</p>
                </div>
                """
            }
