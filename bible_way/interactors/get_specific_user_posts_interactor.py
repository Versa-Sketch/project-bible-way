...
class GetSpecificUserPostsInteractor:
    def __init__(self, storage: UserDB, response: GetSpecificUserPostsResponse):
        self.storage = storage
        self.response = response

    def get_specific_user_posts_interactor(self, user_id: str, current_user_id: str, limit: int = 10, offset: int = 0) -> Response:
        ...
        try:
            result = self.storage.get_user_posts_with_counts(
                user_id=user_id,
                limit=limit,
                offset=offset,
